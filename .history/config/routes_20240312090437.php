...
return function (RouteBuilder $routes): void {
    ...
    $routes->scope('/admin/caracteristicas', function (RouteBuilder $routes) {
        ...
        $routes->connect('/read', ['controller' => 'Pages', 'action' => 'display', 'admin']);
        $routes->connect('/update', ['controller' => 'Pages', 'action' => 'display', 'admin']);
        $routes->connect('/delete', ['controller' => 'Pages', 'action' => 'display', 'admin']);
    });
