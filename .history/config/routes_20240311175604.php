...
return function (RouteBuilder $routes): void {
    ...
    $routes->scope('/', function (RouteBuilder $routes) {
         ...
         */
        $routes->connect('/admin/caracteristicas', ['controller' => 'Caracteristicas', 'action' => 'index']);
        $routes->connect('/admin/caracteristicas/add', ['controller' => 'Caracteristicas', 'action' => 'create', 'caracteristicas']);
        $routes->connect('/admin/caracteristicas/read', ['controller' => 'Caracteristicas', 'action' => 'read', 'caracteristicas']);
