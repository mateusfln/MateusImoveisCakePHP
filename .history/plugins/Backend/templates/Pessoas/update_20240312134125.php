                            ...
                            <div class="card">
                                ...
                                <form method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" required type="text"name="nome" value="<?= $pessoaNome()?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">CPF</label>
                                            <input class="form-control" required type="text" name="cpf" value="<?= $pessoaCpf()?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Login</label>
                                            <input class="form-control" required type="text" name="login" value="<?= $pessoaLogin()?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Senha</label>
                                            <input class="form-control" required type="password" name="senha" value="<?= $pessoaSenha()?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Ativo</label>
                                            <input class="ml-2" type="checkbox" name="ativo" <?= $pessoaAtivo() ? ' checked="checked"' : ''?>>
                                        </div>
                                        <div class="form-group">
