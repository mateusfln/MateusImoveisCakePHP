                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php foreach($caracteristicas as $caracteristica):?>
                                        <tr>
                                            ...
                                            <th><?=$caracteristicaNome()?></th>
                                            <td><?=$caracteristicaAtivo()?></td>
                                            <td><?=$caracteristicaCriado()->format('Y-m-d H:i:s')?></td>
                                            <td><?=$caracteristicaModificado()->format('Y-m-d H:i:s')?></td>
                                            <td><?=$caracteristicaCriadorId()?></td>
                                            <td><?=$caracteristicaModificadorId()?></td>
                                            <td>
                                                <ul class="d-flex justify-content-center">
                                                    <li class="mr-3"><a href="/src/View/adminCrud/Caracteristicas/update.php?id=<?= $caracteristicaId()?>" class="btn btn-inverse-warning"><i class="bi bi-pencil-square mr-1"></i>Edit</a></li>
                                                    <form method="POST">
                                                        <input type="hidden" name="delete_id" value="<?=$caracteristicaId()?>">
