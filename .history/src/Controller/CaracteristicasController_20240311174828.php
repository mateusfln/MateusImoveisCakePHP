...
class CaracteristicasController extends AppController
{
     ...
     * 
     * @return \App\Model\Entity\Caracteristica Objeto Imovel com dados preenchidos
     * @param Imovel $imovel Objeto Imovel com dados a serem preenchidos
     */
    public function index(Imovel $imovel) : Imovel
    {
     ...
     * Cria um registro na tabela imoveis de acordo com os dados fornecidos
     * 
     * @return \App\Model\Entity\Imovel Objeto Imovel com dados preenchidos
     * @param Imovel $imovel Objeto Imovel com dados a serem preenchidos
     */
