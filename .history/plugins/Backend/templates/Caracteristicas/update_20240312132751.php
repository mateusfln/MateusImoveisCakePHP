                                    ...
                                    <div class="col-6 card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" required type="text" name="nome" value="<?= $caracteristicaNome() ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">Ativo</label>
                                                <input class="ml-2" type="checkbox" name="ativo" <?= $caracteristicaAtivo() ? ' checked="checked"' : '' ?>>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6 card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <?php foreach ($imoveltipos as $imoveltipo) : ?>
                                                    <?php $nomePost = str_replace(' ', '_', $imoveltipoNome()); ?>
                                                    <input type="checkbox" name="imoveltipos[]" id="<?= $nomePost ?>" value="<?= $imoveltipoId() ?>" <?= in_array($imoveltipoId(), $arrCaracteristicas) ? ' checked="checked"' : '' ?>>
                                                    <label for="<?= $nomePost ?>" class="col-form-label"><?= $imoveltipoNome() ?></label>
                                                    <br>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
