...
use App\Model\Table\NegociotiposTable;
 ...
 $imoveisTable = new ImoveisTable();
 $imoveis = $imoveisTable->find();

 $estadosTable = new ImoveisTable();
 $estados = $estadosTable->find('list', [
    'fields' => ['DISTINCT Imoveis.estado'],
]);

 //pr($imoveis); die;
 $imoveisAVendaTable = new ImoveisTable();
 $imoveisAVenda = $imoveisAVendaTable->find('all', [
    'conditions' => [
        'ImoveisNegociostipo.negociotipo_id' => 1, // ID do tipo 'Venda'
    ],
    'contain' => [
        'Negociotipos',
        'Imoveltipos',
 ...
 $imoveisAAluguelTable = new ImoveisTable();
 $imoveisAAluguel = $imoveisAAluguelTable->find('all', [
    'conditions' => [
        'ImoveisNegociostipo.negociotipo_id' => 2, // ID do tipo 'Venda'
    ],
    'contain' => [
        'Negociotipos',
        'Imoveltipos',
 ...
 $imoveisTiposTable = new ImoveisTable();
 $imoveisTipos = $imoveisTiposTable->find('list', [
    'fields' => ['id', 'nome'],
    'order' => ['nome ASC'],
]);
 $negociosTiposTable = new NegociotiposTable();
 $negociosTipos = $negociosTiposTable->find();

//dd($negociosTipos); die;

 $imoveisNossosServicosTable = new ImoveisTable();
 $imoveisNossosServicos = $imoveisNossosServicosTable->find();
?>
            ...
            <div class="row">
                ...
                <div class="property-item col-lg-4 col-md-6 col-12 mb-40">
                    <div class="property-inner">
                        ...
                        <div class="image">
                            <a href="comprar.php?id=<?=$imovel img src="<?= $imovel->midias alt="<?= $imovel->midiasa>
                            <ul class="property-feature">
                                <li>
                                    <span class="area"><img src="assets/images/icons/area.png" alt=""><?= $imovelspan>
                                </li>
                                <li>
                                    <span class="bed"><img src="assets/images/icons/bed.png" alt=""><?= $imovelspan>
                                </li>
                                <li>
                                    <span class="bath"><img src="assets/images/icons/bath.png" alt=""><?= $imovelspan>
                                </li>
                                <li>
                                    <span class="parking"><img src="assets/images/icons/parking.png" alt=""><?= $imovelspan>
                                </li>
                            </ul>
                        </div>
                        <div class="content" >
                            <div class="left">
                                <h3 class="title"><a href="comprar.php?id=<?=$imovel $imovela></h3>
                                <span class="location"><img src="assets/images/icons/marker.png" alt=""><?= $imovel ", " .$imovel ".$imovel ".$imovel ?></span>
                            </div>
                            <div class="right">
                                <div class="type-wrap">
                                    <span class="price">R$<?= $imovel->negocioTipos
                                    ...
                                    <span class="type"><?= $imovel->negocioTiposspan>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-12 mb-30">
                    <div class="property-slider-2">
                        ...
                        <div class="property-2">
                            <div class="property-inner">
                                <a href="comprar.php?id=<?=$imovel class="image"><img src="<?= $imovel->midias alt="<?= $imovel->midiasa>
                                <div class="content">
                                    <h4 class="title"><a href="comprar.php?id=<?=$imovel $imovela></h4>
            ...
            <div class="row">
                ...
                <div class="property-carousel section slider-space-30">
                    ...
                    <div class="property-item col">
                        <div class="property-inner">
                            <div class="image">
                                <a href="comprar.php?id=<?=$imovelimg src="<?= $imovel->midias alt="<?= $imovel->midiasa>
                                <ul class="property-feature">
                                    <li>
                                        <span class="area"><img src="assets/images/icons/area.png" alt=""><?=$imovelspan>
                                    </li>
                            ...
                            <div class="content">
                                ...
                                <div class="right">
                                    <div class="type-wrap">
                                        <span class="price">R$<?= $imovel->imovelCaracteristicasImovelTiposspan>M</span></span>
                                        <span class="type"><?= $imovel->negocioTiposspan>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="property-item col">
                        <div class="property-inner">
                            ...
                            <div class="content">
                                ...
                                <div class="right">
                                    <div class="type-wrap">
                                        <span class="price">R$<?= $imovel->imovelCaracteristicasImovelTiposspan>
                                        <span class="type"><?= $imovel->negocioTiposspan>
                                    </div>
                                </div>
                            </div>
