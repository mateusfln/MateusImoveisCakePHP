        ...
        *=========================-->
        <div class="header-area-left">
            <a href="https://mateusimoveis.local/admin" class="logo">
                <span>
                    <img src="/Mateusimoveis/images/logo.png" alt="" height="18">
                </span>
                <i>
                    <img src="/Mateusimoveis/images/logo.png" alt="" height="22">
                </i>
            </a>
        </div>
        <!--======================*
                            ...
                            <div class="dropdown-menu dropdown_user" aria-labelledby="dropdownMenuButton" >
                                <div class="dropdown-header d-flex flex-column align-items-center">
                                    <div class="user_img mb-3">
                                        <img src="/Mateusimoveis/images/user.jpg" alt="User Image">
                                    </div>
