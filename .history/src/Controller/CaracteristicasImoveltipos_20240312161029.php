 ...
 *
 * @property \App\Model\Table\CaracteristicaTable $Caracteristica
 */


class CaracteristicaController extends AppController
{
    /**
    ...
    {
        // echo'index de Caracteristica';
        // die;
        // $Caracteristica = $this->Caracteristica->find();
    ...
    {
        // echo'index de Caracteristica '.$this->request->getParam('id');
        // die;
