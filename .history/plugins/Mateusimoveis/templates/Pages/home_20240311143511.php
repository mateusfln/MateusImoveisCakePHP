        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <?php foreach($imoveis as $imovel):?>
                    C:\wamp64\www\micake\html\plugins\Mateusimoveis\templates
                   
                <div class="property-item col-lg-4 col-md-6 col-12 mb-40">
                    <div class="property-inner">
                        
                        <div class="image">
                            <a href="comprar.php?id=<?=$imovel['id']?>"><img src="/../../../webroot/images/imoveis/65eb7a0442cca.png" alt="<?= $imovel->midias[0]->descricao?>"></a>
