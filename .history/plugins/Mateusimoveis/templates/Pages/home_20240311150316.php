        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <?php foreach($imoveis as $imovel):?>
                    ...
                    <?php $correctRelativePath = substr_replace($imovel->midias[0]->nome_disco, "", 0, 7); // Remove os primeiros 3 caracteres?>
                    <?php /**
                     * @todo arrumar a logica pra mandar os paths certos
                     */ $realPath = 'Mateusimoveis'.$correctRelativePath.'/../65eb7a0442cca.png';?>
                    <br> 
                ...
                <div class="property-item col-lg-4 col-md-6 col-12 mb-40">
                    <div class="property-inner">
                        ...
                        <div class="image">
                            <a href="comprar.php?id=<?=$imovel['id']?>"><img src="<?= $realPath?>" alt="<?= $imovel->midias[0]->descricao?>"></a>
                        ...
                        <div class="content" >
                            ...
                            <div class="right">
                                <div class="type-wrap">
                                    <span class="price">R$<?= $imovel->_joinData['valor']?>
