...
if (!empty($_POST)) {
    ...
    try {
        ...
        $caracteristicaNome($_POST['nome']);
        $caracteristicaAtivo(true);
        $caracteristicaCriado($hoje);
        $caracteristicaCriadorId(1);
        $caracteristicaModificadorId(1);
        $caracteristicaModificado($hoje);
        ...
        foreach ($_POST['imoveltipos'] as $imovel) {
            ...
            $caracteristicasImoveltiposCaracteristicaId($idCaracteristica);
            $caracteristicasImoveltiposImovelTipoId($imovel);
            $caracteristicasImoveltiposAtivo(true);
            $caracteristicasImoveltiposCriado($hoje);
            $caracteristicasImoveltiposCriadorId(1);
            $caracteristicasImoveltiposModificadorId(1);
            $caracteristicasImoveltiposModificado($hoje);
