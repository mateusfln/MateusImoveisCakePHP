                            ...
                            <div class="card">
                                <div class="col-12 d-flex">
                                    <div class="col-6 card">
                                        <div class="card-body">
                                            <h4 class="card_title">Editar <?= $imoveltipo´[() ?></h4>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <?php foreach ($caracteristicas as $caracteristica): ?>
                                                    <?php $nomePost = str_replace(' ', '_', $caracteristica´[()); ?>
                                                    <input type="checkbox" name="caracteristicas[]" id="<?= $nomePost ?>"
                                                        value="<?= $caracteristica´[() ?>"
                                                        <?= in_array($caracteristica´[(), $arrImoveltipos) ? ' checked="checked"' : '' ?>>
                                                    <label for="<?= $nomePost ?>"
                                                        class="col-form-label"><?= $caracteristica´[() ?></label>
                                                    <br>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
