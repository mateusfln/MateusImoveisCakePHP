...
/**
 * CaracteristicasImoveltipos Controller
 *
 * @property \App\Model\Table\CaracteristicasImoveltiposTable $CaracteristicasImoveltipos
 */


class CaracteristicasImoveltiposController extends AppController
{
    /**
    ...
    {
        // echo'index de CaracteristicasImoveltipos';
        // die;
        // $Caracteristica = $this->CaracteristicasImoveltipos->find();
    ...
    {
        // echo'index de CaracteristicasImoveltipos '.$this->request->getParam('id');
        // die;
