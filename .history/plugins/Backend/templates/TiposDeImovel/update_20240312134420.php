                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <?php foreach ($caracteristicas as $caracteristica): ?>
                                                    <?php $nomePost = str_replace(' ', '_', $caracteristicaNome()); ?>
                                                    <input type="checkbox" name="caracteristicas[]" id="<?= $nomePost ?>"
                                                        value="<?= $caracteristicaId() ?>"
                                                        <?= in_array($caracteristicaId(), $arrImoveltipos) ? ' checked="checked"' : '' ?>>
                                                    <label for="<?= $nomePost ?>"
                                                        class="col-form-label"><?= $caracteristicaNome() ?></label>
                                                    <br>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
