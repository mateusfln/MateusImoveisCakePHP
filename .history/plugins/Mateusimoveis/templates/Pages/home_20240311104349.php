...
use App\Model\Table\ImoveltiposTable;
 ...
 $estados = $estadosTable->find();

 //pr($imoveis); die;
 $imoveisAVendaTable = new ImoveisTable();
 $imoveisAVenda = $imoveisAVendaTable->find('i.id, i.identificacao, matricula, inscricao_imobiliaria, logradouro, numero_logradouro, 
 ...
 m.identificacao AS midia_identificacao, m.nome_disco AS midia_nome_disco, m.capa AS midia_capa', [
    'conditions' => [
        'negociotipos.id' => 1, // ID do tipo 'Venda'
    ],
    'contain' => [
        'Negociotipos',
        'Imoveltipos',
...
dd($imoveisAVenda);
 ...
 $imoveisAAluguel = $imoveisAAluguelTable->find('all', [
    'conditions' => [
        'ImoveisNegociostipo.id' => 2, // ID do tipo 'Venda'
    ],
    'contain' => [
        'Negociotipos',
        'Imoveltipos',
