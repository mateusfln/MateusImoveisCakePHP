...
// colocar imoveltipoid em um array


$arrCaracteristicas = [];

foreach ($caracteristicasImoveltipos as $caracteristicas) {
    $arrCaracteristicas[] = $caracteristicas->getImovelTipoId();
}

//print_r($arrCaracteristicas); die;
...
if (!empty($_POST['nome'])) {
    ...
    $caracteristicasImoveltiposDao->deletePorCaracteristica($_GET['id']);
    ...
    foreach ($_POST['imoveltipos'] as $imovel) {
        ...
        $caracteristicasImoveltipos->setCaracteristicaId($_GET['id']);
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <?php foreach ($imoveltipos as $imoveltipo) : ?>
                                                    ...
                                                    <input type="checkbox" name="imoveltipos[]" id="<?= $nomePost ?>" value="<?= $imoveltipo->getId() ?>" <?= in_array($imoveltipo->getId(), $arrCaracteristicas) ? ' checked="checked"' : '' ?>>
