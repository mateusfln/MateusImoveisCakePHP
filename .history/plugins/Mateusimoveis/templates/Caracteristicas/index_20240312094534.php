...
<head>
    ...
    *===========================-->
    ...
    <!--=========================*
                Favicon
    *===========================-->
    <link rel="shortcut icon" type="image/x-icon" href="Mateusimoveis/adminAssets/images/favicon.ico">

    <!--=========================*
            Bootstrap Css
    *===========================-->
    <link rel="stylesheet" href="Mateusimoveis/adminAssets/css/bootstrap.min.css">

    <!--=========================*
              Custom CSS
    *===========================-->
    <link rel="stylesheet" href="Mateusimoveis/adminAssets/css/style.css">

    <!--=========================*
               Owl CSS
    *===========================-->
    <link href="Mateusimoveis/adminAssets/css/owl.carousel.min.css" rel="stylesheet" type="text/css">
    <link href="Mateusimoveis/adminAssets/css/owl.theme.default.min.css" rel="stylesheet" type="text/css">

    <!--=========================*
            Font Awesome
    *===========================-->
    <link rel="stylesheet" href="Mateusimoveis/adminAssets/css/font-awesome.min.css">

    <!--=========================*
             Themify Icons
    *===========================-->
    <link rel="stylesheet" href="Mateusimoveis/adminAssets/css/themify-icons.css">

    <!--=========================*
               Ionicons
    *===========================-->
    <link href="Mateusimoveis/adminAssets/css/ionicons.min.css" rel="stylesheet"/>

    <!--=========================*
              EtLine Icons
    *===========================-->
    <link href="Mateusimoveis/adminAssets/css/et-line.css" rel="stylesheet"/>

    <!--=========================*
              Feather Icons
    *===========================-->
    <link href="Mateusimoveis/adminAssets/css/feather.css" rel="stylesheet"/>

    <!--=========================*
              Flag Icons
    *===========================-->
    <link href="Mateusimoveis/adminAssets/css/flag-icon.min.css" rel="stylesheet"/>

    <!--=========================*
              Material Icons
    *===========================-->
    <link href="Mateusimoveis/adminAssets/css/materialdesignicons.min.css" rel="stylesheet"/>

    <!--=========================*
              Modernizer
    *===========================-->
    <script src="Mateusimoveis/adminAssets/js/modernizr-2.8.3.min.js"></script>

    <!--=========================*
               Metis Menu
    *===========================-->
    <link rel="stylesheet" href="Mateusimoveis/adminAssets/css/metisMenu.css">

    <!--=========================*
               Slick Menu
    *===========================-->
    <link rel="stylesheet" href="Mateusimoveis/adminAssets/css/slicknav.min.css">
    ...
    *===========================-->
    ...
    <!--=========================*
               AM Chart
    *===========================-->
    <link rel="stylesheet" href="Mateusimoveis/adminAssets/vendors/am-charts/css/am-charts.css" type="text/css" media="all" />

    <!--=========================*
               Morris Css
    *===========================-->
    <link rel="stylesheet" href="Mateusimoveis/adminAssets/vendors/charts/morris-bundle/morris.css">

    <!--=========================*
           J Vector Map Css
    *===========================-->
    <link href="Mateusimoveis/adminAssets/vendors/j-vectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
