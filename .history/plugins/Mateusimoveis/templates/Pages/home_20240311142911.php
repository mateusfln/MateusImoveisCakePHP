        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <?php foreach($imoveis as $imovel):?>
                    ...
                    <?= dd($nomeSemMat = substr_replace($nome, "", 0, 3); // Remove os primeiros 3 caracteres
 $imovel->midias[0]->nome_disco)?>
                    <?= dd('../../webroot/'.$imovel->midias[0]->nome_disco)?>
                <div class="property-item col-lg-4 col-md-6 col-12 mb-40">
                    <div class="property-inner">
                        
                        <div class="image">
                            <a href="comprar.php?id=<?=$imovel['id']?>"><img src="<?= '../../webroot/'.$imovel->midias[0]->nome_disco?>" alt="<?= $imovel->midias[0]->descricao?>"></a>
