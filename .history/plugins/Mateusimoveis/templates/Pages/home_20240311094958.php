...
use App\Model\Table\ImoveisTable;
 ...
 $estados = Fazer um find na tabela de imóveis com DISTINCT apenas nos estados no CakePHP
 Para realizar um find na tabela de imóveis com DISTINCT apenas nos estados no CakePHP, você pode utilizar o método distinct() em conjunto com o método find().
 
 Exemplo:
 
 PHP
 $estados = $this->Imoveis->find('list', [
 ...
 $imoveisTipos = new ImoveisTable();
 $imoveisTipos = $imoveisTipos->buscarListaDeImoveisTipo();
 $negociosTipos = new ImoveisTable();
