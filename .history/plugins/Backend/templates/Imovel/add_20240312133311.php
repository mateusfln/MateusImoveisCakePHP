                                                ...
                                                <div class="col-6 card">
                                                    <div class="card-body">
                                                            ...
                                                            <select class="form-control" name='imoveltipo' id='imoveltipo'>
                                                                ...
                                                                <option value="<?=$imoveltipoId()?>" id="<?=$imoveltipoNome()?>"><?=$imoveltipoNome()?></option>
                                                            ...
                                                            <select class="form-control" name='negociotipo'>
                                                                ...
                                                                <option value="<?=$negociotipoId()?>" id="<?=$negociotipoNome()?>"><?=$negociotipoNome()?></option>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                <input type="checkbox" name="caracteristicas[]" id="<?=$caracteristicaId()?>" value="<?=$caracteristicaId()?>">
                                                                <label for="<?=$caracteristicaNome()?>" class="col-form-label"><?=$caracteristicaNome()?></label>
                                                                <br>
                                                                </div>
                                                                <?php endforeach;?>
                                                            </div>
